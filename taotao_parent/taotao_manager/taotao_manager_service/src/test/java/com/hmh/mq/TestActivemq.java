...
public class TestActivemq {
	...
	public void testQueueProducer() throws Exception {
		ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://212.64.71.151:61616");
		...
		// 不同名字的Queue相当于是不同的队列，你要是发生消息的时候，你要注意你这个消息要往哪个队列中发送
		Queue queue = session.createQueue("test-queue");
		// 6.使用Session对象创建一个Producer对象
		MessageProducer producer = session.createProducer(queue);
		// 7.使用Producer对象发生消息
//		TextMessage textMessage = new ActiveMQTextMessage();
//		textMessage.setText("使用ActiceMQ 发送的队列消息11haha");
		TextMessage textMessage2 = session.createTextMessage("使用ActiceMQ 发送的队列水电费水电费消息哈哈哈");
		//发送消息
    ...
    */
	...
	public void testTopicPersistenceProducer() throws JMSException {
		...
		ActiveMQConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://212.64.71.151:61616");
		...
		TextMessage textMessage = session.createTextMessage("hello,我是生产者2号sdf！");
		//11.发送消息

...
public class SendMail {
	...
	public static void sendEmail(String subject, String text) throws MessagingException {
		...
		//这里填你登录163邮箱所用的用户名
		msg.setFrom(new InternetAddress("13548571896@163.com")); //设置发件人，163邮箱要求发件人与登录用户必须一致（必填），其它邮箱不了解
		...
		trans.connect("smtp.163.com", 25, "13548571896@163.com", "kj89910"); //连接邮箱smtp服务器，25为默认端口
		//要发送到哪个邮箱，这里以qq邮箱为例
		trans.sendMessage(msg, new Address[]{new InternetAddress("934178858@qq.com")}); //发送邮件

		...
		<div class="fr">
			<div class="sm" id="branch-office">
				...
				<div class="smc">
					...
					<p class="ar"><a href="http://help.jd.com/help/distribution-768.html" target="_blank">查看详情&nbsp;></a>
                    </p>
				</div>
			</div>
		</div>
...
var A="<strong>热门搜索：</strong>" +
    "<a href='http://sale.jd.com/act/OfHQzJ2GLoYlmTIu.html' target='_blank' style='color:#ff0000' clstag='homepage|keycount|home2013|03b1'>校园之星</a>" +
    "<a href='http://sale.jd.com/act/aEBHqLFMfVzDZUvu.html' target='_blank'>办公打印</a>" +
    "<a href='http://www.jd.com/pinpai/878-12516.html' target='_blank'>美菱冰箱</a>" +
    "<a href='http://sale.jd.com/act/nuzKb6ZiYL.html' target='_blank'>无肉不欢</a>" +
    "<a href='http://sale.jd.com/act/ESvhtcAJNbaj.html' target='_blank'>万件好货</a>" +
    "<a href='http://sale.jd.com/act/nAqiWgU34frQolt.html' target='_blank'>iPhone6</a>" +
    "<a href='http://sale.jd.com/act/p0CmUlEFPHLX.html' target='_blank'>哈利波特</a>" +
    "<a href='http://sale.jd.com/act/FstSdb2vCOLa8BRi.html' target='_blank'>美模接驾</a>";
